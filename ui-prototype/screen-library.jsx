// screen-library.jsx — 结构样例库 (merged Structure + Example library)

const ScreenLibrary = ({ onBack }) => {
      ...
      <div className="screen">
            ...
            <div className="panel-body" style={{ display: "flex", gap: 16 }}>
              ...
              <div style={{
                ...
                <div style={{ position: "absolute", inset: 0, opacity: 0.4 }}>
                  {React.createElement(SVG_BY_ROLE[v.segments[0].role] || SvgHookShape)}
                </div>
                <div style={{
        ...
        <div className="panel" style={{ marginBottom: 16 }}>
          ...
          <div className="panel-body">
            ...
            {/* Film strip */}
            <SyncRails segments={v.segments.reduce((acc, s, i) => {
