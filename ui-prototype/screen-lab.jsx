// screen-lab.jsx — 屏 6 · 结构实验室 ★★ THE KEY SCREEN
...
const ResequencedBand = ({ structure, materials, height = 38 }) => {
...
const LabDirectionB = () => {
  const T = LAB_STRUCTURES[0].durations.reduce((a,b)=>a+b, 0);
  return (
    <div className="col">
