...
// screen-history.tsx — 历史版本 (previously generated materials)
// (Ported from screen-history.jsx; React/window globals replaced with imports.)

import { createElement, useState, type FC } from 'react';
import { HISTORY_RECORDS, ROLES, type HistoryRecord } from './data';
import {
  Icon,
  ScreenFooter,
  SvgCompareShape,
...
export const ScreenHistory = ({ onReEdit }: { onReEdit?: () => void }) => {
  ...
  const statusMeta: Record<string, { label: string; color: string; bg: string; line: string }> = {
            ...
            <div className="panel-body" style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
              <div style={{
                ...
                <div style={{ position: 'absolute', inset: 0, opacity: 0.3 }}>
                  {createElement(SVG_BY_ROLE[r.segments[0]] || SvgHookShape)}
                </div>
                <div style={{
